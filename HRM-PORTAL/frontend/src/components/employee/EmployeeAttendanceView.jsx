    ...
    <div className="view">
      ...
      <div className="panel">
        <div className="panel-body" style={{ display: 'flex', gap: 20, alignItems: 'center', justifyContent: 'center', padding: 32 }}>
          <button className="btn btn-solid" style={{ height: 54, padding: '0 48px', fontSize: '1.1rem', borderRadius: 30 }} onClick={handleClockIn} disabled={clocking || !!todayRecord}>
            Clock In
          </button>
          <button className="btn btn-outline" style={{ height: 54, padding: '0 48px', fontSize: '1.1rem', borderRadius: 30 }} onClick={handleClockOut} disabled={clocking || !todayRecord || !!todayRecord?.clock_out}>
            Clock Out
          </button>
        </div>
      </div>
