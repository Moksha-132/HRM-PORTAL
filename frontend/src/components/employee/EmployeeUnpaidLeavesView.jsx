...
const EmployeeUnpaidLeavesView = () => {
  ...
  const calculateUnpaidMonthly = (monthYear) => {
    ...
    return leaves
      .filter(l => {
        ...
        if (l.leave_type !== 'Unpaid Leave') return false;
  ...
  return (
    <div className="view">
      ...
      <div className="page-header">
        <h1 className="page-h1">Unpaid Leaves</h1>
      </div>
...
export default EmployeeUnpaidLeavesView;
