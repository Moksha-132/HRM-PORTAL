...
const EmployeeOverviewView = () => {
  ...
  return (
    <div className="view">
      ...
      {/* 4. Combined Section (Single Row Layout: Appreciations, Expenses, Complaints) */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px', marginBottom: '24px' }}>
         ...
         <div className="stat-card" style={{ background: '#fffbeb', borderColor: '#fde68a' }}>
            <div className="stat-val" style={{ color: '#92400e' }}>0</div>
            <div className="stat-label" style={{ color: '#92400e' }}>Active Complaints (N/A)</div>
         </div>
      </div>
